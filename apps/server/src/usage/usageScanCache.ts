...
export interface CachedFile {
  ...
  /** Pi project paths used to discover child sessions even on a warm scan. */
...
/** Invalid Pi state must cold parse rather than lose appended session/model attribution. */
