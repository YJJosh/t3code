...
function ChatViewContent(props: ChatViewProps) {
  ...
  const workLogEntries = useMemo(
    () =>
      deriveWorkLogEntries(threadActivities, {
        showAgentReasoning: settings.showAgentReasoning,
      }),
    [settings.showAgentReasoning, threadActivities],
  );
  ...
  const onSend = async (
    ...
    if (shouldCreateWorktree && !activeThreadBranch) {
      setThreadError(threadIdForSend, "Select a base branch before sending in New workspace mode.");
      return;
    }
