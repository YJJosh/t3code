...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    searchTerms: [
      "agents cli codex claude cursor grok opencode pi profiles agent directory antigravity google sign in sign out install subscription instances authentication api key models configuration binary path config directory endpoint arguments environment variables display name accent color custom favorite hidden auto compact",
    ],
  },
  {
    id: "usage-providers",
