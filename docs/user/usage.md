...
Pi totals include supported legacy session locations and subagent child sessions discoverable
from a parent session's project. History copied into forked sessions is counted only once.
Usage scans include the transcript homes of every configured provider instance.

Use **Past 24h** for an hourly chart covering the exact rolling 24-hour period. The **7 days**,
**30 days**, and **90 days** ranges use daily resolution.
